...
define([
    ...
    VisualizersJSON = JSON.parse(VisualizersJSON)
        .filter(viz => viz.panel.indexOf('/VizSetterPanel') === -1);
    ...
    VizSetterPanel = function (layoutManager, params) {
    ...
    VizSetterPanel.prototype._initialize = function() {
    ...
    VizSetterPanel.prototype.onActiveObjectChanged = function(model, nodeId) {
    ...
    VizSetterPanel.prototype.update = function() {
        var panelId,
            panelIndex;
    ...
    VizSetterPanel.prototype.setPanel = function(panelDesc) {
        var panel,
            self = this,
            containerSize;
    ...
    VizSetterPanel.prototype.getPanel = function(panelPath, callback) {
        var self = this;
    ...
    _.extend(VizSetterPanel.prototype, PanelBase.prototype);
    ...
    for (var i = FWRD_FUNCS.length; i--;) {
        VizSetterPanel.prototype[FWRD_FUNCS[i]] = function() {
